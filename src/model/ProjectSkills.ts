import type { ProjectSkillObject } from '../model/ProjectSkill';
import { ProjectSkill } from '../model/ProjectSkill';
import {
  Builder,
  CICD,
  Cloud,
...
import type { ISKills } from '../model/Skills';
import { getSkillsFrom } from '../model/ISkills';
import type { ProjectDataObject } from './Project';
